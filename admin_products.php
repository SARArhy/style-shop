...
<head>
    ...
    <link href="css/admin_productstyle.css" rel="stylesheet" type="text/css" />
</head>
<body>
<?php
...
<form name="add_product" action="action_admin_products.php<?php if (!empty($url)) echo($url); ?>" method="POST" enctype="multipart/form-data">
    <table>
        <tr>
            ...
            <td><input type="text" id="pro_code" name="pro_code" value="<?php echo ($pro_code) ?>" /></td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td><input type="text" id="pro_price" name="pro_price" value="<?php echo ($pro_price) ?>" /> تومان</td>
        </tr>
        <tr>
            <td>آپلود تصویر: <span style="color: red;">*</span></td>
            <td>
